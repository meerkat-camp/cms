// @editorjs/header@2.8.8 downloaded from https://ga.jspm.io/npm:@editorjs/header@2.8.8/dist/header.mjs
 ...
 * @license MIT
 * @version 2.0.0
 */class v{constructor({data:e,config:t,api:r,readOnly:n}){this.api=r,this.readOnly=n,this._settings=t,this._data=this.normalizeData(e),this._element=this.getTag()}get _CSS(){return{block:this.api.styles.block,wrapper:"ce-header"}}
/**
   ...
   * @private
   */isHeaderData(e){return e.text!==void 0}
/**
   ...
   * @returns {HeaderData}
   * @private
   */normalizeData(e){const t={text:"",level:this.defaultLevel.number};return this.isHeaderData(e)&&(t.text=e.text||"",e.level!==void 0&&!isNaN(parseInt(e.level.toString()))&&(t.level=parseInt(e.level.toString()))),t
/**
   * Return Tool's view
   *
...
/**
   ...
   * @public
   */merge(e){this._element.insertAdjacentHTML("beforeend",e.text)}
/**
...
/**
   ...
   */static get toolbox(){return{icon:a,title:"Heading"}}}export{v as default};
