...
/**
   ...
   */onPaste(e){var t;const{key:i,data:r}=e.detail,{regex:o,embedUrl:a,width:l,height:d,id:n=(e=>e.shift()||"")}=m.services[i],c=(t=o.exec(r))==null?void 0:t.slice(1),u=c?a.replace(/<%= remote_id %>/g,n(c)):"";this.data={service:i,source:r,embed:u,width:l,height:d}}
/**
